...
public class GoalRequest {
    ...
    @PositiveOrZero(message = "Monthly contribution cannot be negative")
    private BigDecimal monthlyContribution = BigDecimal.ZERO;

    public GoalRequest() {
    }

    public GoalRequest(String title, String description, BigDecimal targetAmount, LocalDate targetDate,
            Priority priority) {
        this.title = title;
